...
$("#autoGenerate").click(function() {
  ...
  switch (autoGenerateRandomizer++) {
    case 0:
      generateBellmanFordGraph(graphArea);
      break;
    case 1:
      generateLeaderElectGraph(graphArea);
      break;
    case 2:
      generateLubyMISGraph(graphArea);
      break;
    default:
...
$("#addEdgeButton").click(function() {
  addEdge(graphArea, false);
});
$("#addDirEdgeButton").click(function() {
  addEdge(graphArea, true);
});


// Handlers for enter key
$("#endNode").keydown(function(e) {
  if (e.keyCode == 13) {
    $("#addEdgeButton").click()
  }
});
$("#weight").keydown(function(e) {
  if (e.keyCode == 13) {
    $("#addDirEdgeButton").click()
  }
});
$("#algorithmStartNode").keydown(function(e) {
  if (e.keyCode == 13) {
    $("#playModeButton").click()
  }
});
$("#noRounds").keydown(function(e) {
  if (e.keyCode == 13) {
    $("#playModeButton").click()
  }
});
